...
export default function Order() {
	...
	function handlerSubmit(event) {
		...
		alert(
			'Your request has been sent, we will contact with you soon, thank you!'
		);
	}

	return (
		<section className="order" id="shop">
			...
			<div className="order__wrapper">
				...
				>
					...
					<div className="form__field">
						<label className="form__label" htmlFor="tel-1">
							phone
						</label>
						<input
							className="form__input"
					...
					<div className="form__field">
						<label className="form__label" htmlFor="volume">
							order value
						</label>{' '}
						<br />
						<select
							...
							required
						>
							<option className="form__option" value="value-0">
								Other
							</option>
							<option className="form__option" value="value-1">
								10 barrel per week
							</option>
							<option className="form__option" value="value-2">
								20 barrel per week
							</option>
							<option className="form__option" value="value-3">
								30 barrel per week
							</option>
						</select>
					</div>
